    ...
    <div className="w-full max-w-md mx-auto px-4">
      ...
      <div className="text-center mb-8 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm sm:text-base text-slate-400 font-medium">Finanças em Casal</p>
        </div>
      </div>
      ...
      <div className="mt-6 sm:mt-8 text-center space-y-3 px-4">
        <p className="text-sm text-slate-400">
          Primeira vez aqui?{' '}
          <span className="text-emerald-400 font-semibold">Crie sua conta grátis</span>
        </p>
