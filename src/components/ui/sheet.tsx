    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'bottom' &&
          'data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 border-t pb-[env(safe-area-inset-bottom)]',
          (side === 'right' || side === 'left') && 'h-[100dvh]',
          className
        )}
        {...props}
      >
