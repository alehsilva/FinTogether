      ...
      <div className="flex h-16 items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {isConfigPage && (
            <Button
              variant="ghost"
              size="sm"
              className="lg:hidden cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors duration-150"
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="relative h-12 px-3 hover:bg-slate-100 dark:hover:bg-slate-700/50 rounded-full transition-colors duration-150"
            >
                ...
                <div className="flex items-center -space-x-2">
                  ...
                  <Avatar className="h-9 w-9 border-2 border-white dark:border-slate-800 ring-2 ring-slate-300 dark:ring-slate-600">
                    {partner ? (
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-slate-700 to-slate-800 dark:from-slate-900 dark:to-black text-slate-200 dark:text-slate-400 hover:from-slate-600 hover:to-slate-700 transition-colors duration-150 cursor-pointer">
                        <svg
                          className="h-4 w-4"
                          fill="none"
                          stroke="currentColor"
          ...
          <DropdownMenuContent
            align="end"
            className="w-64 p-2 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/50 transition-colors duration-150"
          >
            {/* Header do dropdown com info do usuário */}
            <div className="flex items-center gap-3 p-2 mb-2 bg-slate-50 dark:bg-slate-700/30 border border-slate-200 dark:border-slate-700/50 rounded-lg transition-colors duration-150">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-medium text-slate-700 dark:text-slate-400 truncate">
                  {user.email}
                </p>
              </div>
            </div>
            ...
            <div className="px-2 py-2">
              <p className="text-xs font-semibold text-slate-700 dark:text-slate-400 mb-2 px-2">
                APARÊNCIA
              </p>
