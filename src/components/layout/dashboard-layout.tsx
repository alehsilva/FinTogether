...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="h-screen-mobile flex bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative transition-colors duration-150" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
