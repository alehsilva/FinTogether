      ...
      <div className="block lg:hidden px-4">
        <div>
          ...
          <input
            ...
            className="w-full max-w-none box-border bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 rounded-lg px-4 py-3 text-base text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-500 focus:border-emerald-500 dark:focus:border-emerald-500 focus:outline-none transition-colors duration-150 [-webkit-appearance:none] [appearance:none]"
          />
        </div>
      </div>
        ...
        <div className="mb-2">
          <div className="flex items-center justify-between text-sm mb-2">
            <Button
              ...
              className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-700/60 rounded-lg transition-all duration-150 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-100 group"
            >
