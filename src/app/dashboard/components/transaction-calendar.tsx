...
export function TransactionCalendar({
    ...
    return (
        <div className="p-3 bg-gradient-to-br from-white to-slate-50 dark:from-slate-800/40 dark:to-slate-900/40 mx-0 lg:mx-4 mt-2 rounded-lg overflow-x-hidden border border-slate-200 dark:border-slate-700/30 backdrop-blur-sm shadow-md transition-colors duration-300">
            <div className="mb-2">
