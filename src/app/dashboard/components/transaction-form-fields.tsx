    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <div className="relative">
                            <span className="pointer-events-none absolute inset-y-0 left-3 flex items-center text-slate-500 dark:text-slate-400 text-xs">
                                R$
                            </span>
                            <Input
                                type="text"
                ...
                />
                {errors.valor && (
                    <p className="text-red-500 dark:text-red-400 text-xs mt-0.5">{String(errors.valor?.message || '')}</p>
                )}
            </div>
            ...
            <div>
                ...
                />
                {errors.titulo && (
                    <p className="text-red-500 dark:text-red-400 text-xs mt-0.5">{String(errors.titulo?.message || '')}</p>
                )}
            </div>
            ...
            <div>
                ...
                <Controller
                    ...
                    render={({ field }) => {
                        ...
                        const options = useMemo(() => {
                            ...
                            const semCategoria = filteredCategories.find(cat =>
                                cat.name === 'Sem Categoria' && cat.is_system === true
                            );
                ...
                />
                {errors.categoria && (
                    <p className="text-rose-500 dark:text-rose-400 text-xs mt-0.5">{String(errors.categoria?.message || '')}</p>
                )}
            </div>
            ...
            <div>
                ...
                />
                {errors.privacidade && (
                    <p className="text-red-500 dark:text-red-400 text-xs mt-0.5">{String(errors.privacidade?.message || '')}</p>
                )}
            </div>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <Input
                                ...
                                className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 rounded px-3 py-2 text-sm text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-500 focus:border-orange-500 dark:focus:border-orange-500 focus:outline-none transition-colors duration-200"
