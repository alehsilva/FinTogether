...
export default function ConfiguracoesPage() {
  ...
  const isPendingInviter =
    couple?.status === 'pending' && couple.partner_1_email?.toLowerCase() === myEmail;
  ...
  const partnerEmailFromState = useMemo(() => {
    if (isActive) {
      return couple.partner_1_email?.toLowerCase() === myEmail
    ...
    return '';
  }, [isActive, isPendingInviter, isPendingInvitee, couple, pending, myEmail]);
  ...
  const confirmAsInviter = async () => {
    ...
    try {
      ...
      setCouple(c);
      setMessage(
        c.status === 'active' ? 'Pareamento ativado!' : 'Aceite confirmado. Aguardando parceiro(a).'
      );
      setMessageType('success');
    } catch (error: any) {
  ...
  return (
    <div className="relative h-full overflow-y-auto bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className="relative container mx-auto py-4 px-4 sm:py-6 sm:px-6 max-w-4xl min-h-full">
        ...
        <Card className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-xl border-slate-300 dark:border-slate-700/50 shadow-lg">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                      Informações da sua conta no FinTogether
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                  <div className="flex items-center gap-4 w-full sm:w-auto">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-base sm:text-lg text-slate-900 dark:text-slate-100 mb-1 truncate">
                        {currentUserName}
                      </h3>
                  ...
                  <Button
                    ...
                    className="border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-slate-400 dark:hover:border-slate-500 cursor-pointer shadow-sm w-full sm:w-auto"
                  >
                    <svg
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Conecte-se com seu(ua) parceiro(a) para compartilhar finanças
                    </p>
                  </div>
                </div>
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-blue-800 dark:text-blue-400 leading-relaxed break-words">
                            <strong className="break-all">{pending.partner_1_email}</strong> te
                            convidou para formar um casal no FinTogether.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4 min-w-0 flex-1">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-emerald-700 dark:text-emerald-400 font-medium break-words break-all">
                              Parceiro: {partnerEmailFromState}
                            </p>
                          </div>
                        </div>
                        <Button
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-blue-800 dark:text-blue-400 leading-relaxed break-words">
                            ...
                            <strong className="break-all">{partnerEmailFromState}</strong>.
                            {inviterAccepted
                              ? ' Você já confirmou seu aceite. '
                              : ' Confirme seu aceite para agilizar a ativação. '}
                            {inviteeAccepted
                              ? ' Parceiro(a) já aceitou.'
                              : ' Aguardando aceite do(a) parceiro(a).'}
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-3">
